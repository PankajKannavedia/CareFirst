	...
	<div id="topbar" class="d-flex align-items-center fixed-top">
		<div class="container d-flex justify-content-between">
			<div class="contact-info d-flex align-items-center">
				<i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">kannavediaji@gmail.com</a>
				<i class="bi bi-phone"></i> +91 7566545206
			</div>
		...
		<section id="contact" class="contact">
			...
			<div>
				<iframe style="border: 0; width: 100%; height: 350px;"
					src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1833.9729647203872!2d76.66536909824543!3d23.17217346958156!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397cc79b346901ad%3A0x8b83bba33e4eab!2sKannavedia!5e0!3m2!1sen!2sin!4v1669569890885!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
					...
					<div class="col-lg-4">
						<div class="info">
							<div class="address">
								...
								<h4>Location:</h4>
								<p>Maina, Madhya Pradesh, Pin - 466125</p>
							</div>

							<div class="email">
								<i class="bi bi-envelope"></i>
								<h4>Email:</h4>
								<p>kannavediaji@gmail.com</p>
							</div>
	...
	<footer id="footer">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 footer-contact">
						<h3>CareFirst</h3>
						<p>
							Maina <br> Madhya Pradesh,<br> India, Pin -466125
							<br> <br> <strong>Phone:</strong> +917566545206
							<br> <strong>Email:</strong>kannavediaji@gmail.com<br>
						</p>
					</div>
		...
		<div class="container d-md-flex py-4">
			...
			<div class="me-md-auto text-center text-md-start">
				<div class="copyright">
					&copy; Copyright <strong><span>CareFirst</span></strong>. All Rights
					Reserved
				</div>
				<div class="credits">
					...
					Designed by <a href="https://bootstrapmade.com/">Pankaj Kannavedia</a>
				</div>
			</div>
